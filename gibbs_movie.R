...
gibbs_cpo <- function(nIter, Us, Rs, Vs, Ws, Zs, Ys, sigma2, tau2, type_data="ordinal"){
      ...
      for(j in 1:p){
        ...
        if(type_data=="ordinal"){if(is.na(data[i,j])==F){
          ...
          if(data[i,j]==0.5){
            ...
            Zs[i,j] <- rtnorm(1, lower=-Inf, upper=-0.75, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==1){
            ...
            Zs[i,j] <- rtnorm(1, lower =-0.75, upper =1.25, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==1.5){
            ...
            Zs[i,j] <- rtnorm(1, lower=1.25, upper=1.75, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==2){
            ...
            Zs[i,j] <- rtnorm(1, lower=1.75, upper=2.25, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==2.5){
            ...
            Zs[i,j] <- rtnorm(1, lower=2.25, upper=2.75, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==3){
            ...
            Zs[i,j] <- rtnorm(1, lower=2.75, upper=3.25, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==3.5){
            ...
            Zs[i,j] <- rtnorm(1, lower=3.25, upper=3.75, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==4){
            ...
            Zs[i,j] <- rtnorm(1, lower=3.75, upper=4.25, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==4.5){
            ...
            Zs[i,j] <- rtnorm(1, lower=4.25, upper=4.75, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
          ...
          if(data[i,j]==5){
            ...
            Zs[i,j] <- rtnorm(1, lower=4.75, upper=Inf, mean = Us[i,]%*%Vs[,j], sqrt(sigma2))
      ...
      for(i in 1:n){
        for(j in 1:p){
          ...
          if(is.na(data[i,j])==F){
            ...
            if(data[i,j]==0.5){
              newz <- -log(pnorm(sc_cutoff[1], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)
            }
            if(data[i,j]==1){
              newz <- -log(pnorm(sc_cutoff[2], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[3], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==1.5){
              newz <- -log(pnorm(sc_cutoff[3], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[4], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==2){
              newz <- -log(pnorm(sc_cutoff[4], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[5], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==2.5){
              newz <- -log(pnorm(sc_cutoff[5], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[6], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==3){
              newz <- -log(pnorm(sc_cutoff[6], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[7], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==3.5){
              newz <- -log(pnorm(sc_cutoff[7], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[8], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==4){
              newz <- -log(pnorm(sc_cutoff[8], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[9], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==4.5){
              newz <- -log(pnorm(sc_cutoff[9], Us[i,]%*%Vs[,j], sqrt(sigma2))-pnorm(sc_cutoff[10], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)

            }
            if(data[i,j]==5){
              newz <- -log(1-pnorm(sc_cutoff[10], Us[i,]%*%Vs[,j], sqrt(sigma2))+1)
...
gibbs <- function(nIter, Us, Rs, Vs, Ws, Zs, Ys, sigma2, tau2, type_data="ordinal"){
